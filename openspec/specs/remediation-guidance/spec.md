...
User value: A user triaging a vulnerable action is only ever offered a command that actually resolves the advisory, and when no command is offered they are told exactly what stands in the way.
