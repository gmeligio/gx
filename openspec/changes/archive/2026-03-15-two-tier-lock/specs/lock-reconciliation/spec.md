### MODIFIED Requirement: Lock completeness is checked across both tiers
...
### MODIFIED Requirement: Incomplete entries trigger targeted operations
...
### MODIFIED Requirement: Self-healing on schema additions
