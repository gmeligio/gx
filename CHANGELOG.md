...
- *(lint)* [**breaking**] make excessive-permissions default to error ([#89](https://github.com/gmeligio/gx/pull/89))

## [0.7.2](https://github.com/gmeligio/gx/compare/v0.7.1...v0.7.2) - 2026-05-26

### Added

- *(lint)* add six workflow-security rules (0.8.0) ([#87](https://github.com/gmeligio/gx/pull/87))
